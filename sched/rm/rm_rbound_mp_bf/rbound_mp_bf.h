...
#ifndef __RBOUND_MP_BF__
#define __RBOUND_MP_BF__
...
extern processor_t*  start_rbound_mp_bf(int nproc, char *file );
extern processor_t*  start_rbound_mp_bf_main(int argc, char *argv[] );
