 ...
 *
 * $Id: tclxml.h,v 1.3 2004/02/20 09:15:51 balls Exp $
 *
 */
...
#define TCLXML_MINOR_VERSION	0
#define TCLXML_RELEASE_LEVEL	TCL_RELEASE
#define TCLXML_RELEASE_SERIAL	7

#define TCLXML_VERSION		"3.0"
#define TCLXML_PATCH_LEVEL	"3.0"
