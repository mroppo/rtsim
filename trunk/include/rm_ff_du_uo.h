...
#ifndef __RM_FF_DU_UO__
#define __RM_FF_DU_UO__
...
extern processor_t*  start_rm_ff_du_uo(int nproc, char *file );
extern processor_t*  start_rm_ff_du_uo_main(int argc, char *argv[] );
