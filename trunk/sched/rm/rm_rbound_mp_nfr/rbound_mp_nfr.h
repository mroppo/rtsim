...
#ifndef __RBOUND_MP_NFR__
#define __RBOUND_MP_NFR__
...
extern processor_t*  start_rbound_mp_nfr(int nproc, char *file );
extern processor_t*  start_rbound_mp_nfr_main(int argc, char *argv[] );
