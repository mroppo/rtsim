...
#ifndef __RM_BF_DU_UO__
#define __RM_BF_DU_UO__
...
extern processor_t*  start_rm_bf_du_uo(int nproc, char *file );
extern processor_t*  start_rm_bf_du_uo_main(int argc, char *argv[] );
