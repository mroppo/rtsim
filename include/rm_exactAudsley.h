...
#ifndef __RM_EXACT_AUDSLEY__
#define __RM_EXACT_AUDSLEY__
...
extern int start_rm_exactAudsley(int nproc, char *file);
extern int start_rm_exactAudsley_main(int argc, char *argv[]);
